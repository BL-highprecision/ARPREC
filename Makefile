...
DIST_COMMON = README $(am__configure_deps) $(dist_doc_DATA) \
	...
	$(srcdir)/arprec-config.in $(srcdir)/config.h.in \
	$(top_srcdir)/configure \
	$(top_srcdir)/include/arprec/arprec_config.h.in AUTHORS \
...
CONFIG_CLEAN_FILES = arprec-config
...
STRIP = 
VERSION = 2.2.1
abs_builddir = /Users/dhbailey/Documents/arprec-2.2.20
abs_srcdir = /Users/dhbailey/Documents/arprec-2.2.20
...
include/arprec/arprec_config.h: include/arprec/stamp-h2
	@if test ! -f $@; then \
	  rm -f include/arprec/stamp-h2; \
	  $(MAKE) $(AM_MAKEFLAGS) include/arprec/stamp-h2; \
	else :; fi

include/arprec/stamp-h2: $(top_srcdir)/include/arprec/arprec_config.h.in $(top_builddir)/config.status
	@rm -f include/arprec/stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status include/arprec/arprec_config.h

distclean-hdr:
	-rm -f config.h stamp-h1 include/arprec/arprec_config.h include/arprec/stamp-h2
arprec-config: $(top_builddir)/config.status $(srcdir)/arprec-config.in
